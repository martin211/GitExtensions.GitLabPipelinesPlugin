...
namespace GitLabApiClient
{
    public sealed class WebhookClient : IWebhookClient
    {
        ...
        {
            return await _httpFacade.Get<Webhook>($"projects/{projectId}/hooks/{hookId}");
        }
        ...
        {
            return await _httpFacade.Post<Webhook>($"projects/{projectId}/hooks", request);
        }
        ...
        {
            return await _httpFacade.Put<Webhook>($"projects/{projectId}/hooks/{hookId}", request);
        }
    }
}
