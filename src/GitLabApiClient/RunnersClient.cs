...
namespace GitLabApiClient
{
    ...
    public sealed class RunnersClient : IRunnersClient
    {
        ...
        {
            return await _httpFacade.GetPagedList<Runner>("runners");
        }
        ...
        {
            return await _httpFacade.GetPagedList<Runner>("runners/all");
        }
        ...
        {
            return await _httpFacade.Put<Runner>($"runners/{runnerId}", request);
        }
        ...
        {
            return await _httpFacade.Post<RunnerToken>("runners", request);
        }
