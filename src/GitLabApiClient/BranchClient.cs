...
namespace GitLabApiClient
{
    public sealed class BranchClient : IBranchClient
    {
        ...
        {
            return await _httpFacade.Post<Branch>($"projects/{projectId}/repository/branches", request);
        }
        ...
        {
            return await _httpFacade.Get<ProtectedBranch>($"projects/{projectId}/protected_branches/{branchName}");
        }
        ...
        {
            return await _httpFacade.GetPagedList<ProtectedBranch>($"projects/{projectId}/protected_branches");
        }
        ...
        {
            return await _httpFacade.Post<ProtectedBranch>($"projects/{projectId}/protected_branches", request);
        }
