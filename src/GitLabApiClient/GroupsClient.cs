...
namespace GitLabApiClient
{
    ...
    public sealed class GroupsClient : IGroupsClient
    {
        ...
        {
            return await _httpFacade.GetPagedList<Group>($"groups/{groupId}/subgroups");
        }
        ...
        public async Task<IList<Project>> GetProjectsAsync(GroupId groupId,
            Action<ProjectsGroupQueryOptions> options = null)
        {
        ...
        public async Task<IList<Milestone>> GetMilestonesAsync(GroupId groupId,
        ...
        {
            return await _httpFacade.Get<Milestone>($"groups/{groupId}/milestones/{milestoneId}");
        }
        ...
        {
            return await _httpFacade.Get<IList<Runner>>($"groups/{groupId}/runners");
        }
        ...
        {
            return await _httpFacade.Post<Group>($"groups/{groupId}/projects/{projectId}");
        }
        ...
        {
            return await _httpFacade.Put<Group>($"groups/{groupId}", request);
        }
        ...
        public async Task<Milestone> UpdateMilestoneAsync(GroupId groupId, int milestoneId,
        ...
        {
            return await _httpFacade.GetPagedList<Variable>($"groups/{groupId}/variables");
        }
