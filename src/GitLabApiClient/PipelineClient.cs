...
namespace GitLabApiClient
{
    public sealed class PipelineClient : IPipelineClient
    {
        ...
        {
            return await _httpFacade.Get<PipelineDetail>($"projects/{projectId}/pipelines/{pipelineId}");
        }
        ...
        {
            return await _httpFacade.Get<IList<PipelineVariable>>(
                $"projects/{projectId}/pipelines/{pipelineId}/variables");
        }

        public async Task<IList<Job>> GetJobsAsync(ProjectId projectId, int pipelineId,
            Action<JobQueryOptions> options = null)
        {
        ...
        {
            return await _httpFacade.Post<PipelineDetail>($"projects/{projectId}/pipeline", request);
        }
        ...
        {
            return await _httpFacade.Post<PipelineDetail>(
        ...
        {
            return await _httpFacade.Post<PipelineDetail>($"projects/{projectId}/pipelines/{pipelineId}/retry");
        }
    }
}
