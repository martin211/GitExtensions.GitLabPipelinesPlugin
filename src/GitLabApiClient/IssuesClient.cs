...
namespace GitLabApiClient
{
    ...
    public sealed class IssuesClient : IIssuesClient
    {
        ...
        /// <summary>
        ///     Retrieves issues.
        ///     By default retrieves opened issues from all users. The more specific setting win (if both project and group are
        ///     set, only project issues will be retrieved).
        /// </summary>
        /// <example>
        ///     <code>
        /// /* Get all issues */
        ...
        {
            return GetAllAsync(projectId, options: options);
        }
        ...
        {
            return GetAllAsync(options: options);
        }
        ...
        {
            return await _httpFacade.Get<Note>($"projects/{projectId}/issues/{issueIid}/notes/{noteId}");
        }
        ...
        public async Task<IList<Note>> GetNotesAsync(ProjectId projectId, int issueIid,
            Action<IssueNotesQueryOptions> options = null)
        {
            ...
            string url =
                _projectIssueNotesQueryBuilder.Build($"projects/{projectId}/issues/{issueIid}/notes", queryOptions);
        ...
        {
            return await _httpFacade.Post<Issue>($"projects/{projectId}/issues", request);
        }
        ...
        {
            return await _httpFacade.Post<Note>($"projects/{projectId}/issues/{issueIid}/notes", request);
        }
        ...
        {
            return await _httpFacade.Put<Issue>($"projects/{projectId}/issues/{issueIid}", request);
        }
        ...
        public async Task<Note> UpdateNoteAsync(ProjectId projectId, int issueIid, int noteId,
            UpdateIssueNoteRequest request)
        {
            return await _httpFacade.Put<Note>($"projects/{projectId}/issues/{issueIid}/notes/{noteId}", request);
        }
