...
namespace GitLabApiClient.Models.Pipelines.Responses
{
    public class PipelineDetail
    {
        ...
        [JsonProperty("status")] public PipelineStatus Status { get; set; }

        [JsonProperty("web_url")] public Uri WebUrl { get; set; }

        [JsonProperty("before_sha")] public string BeforeSha { get; set; }

        [JsonProperty("tag")] public bool Tag { get; set; }

        [JsonProperty("yaml_errors")] public string YamlErrors { get; set; }

        [JsonProperty("user")] public PipelineUser User { get; set; }
        ...
        [JsonProperty("committed_at")] public DateTime? CommittedAt { get; set; }
