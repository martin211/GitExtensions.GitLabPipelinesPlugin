...
namespace GitLabApiClient.Models.Commits.Responses
{
    public sealed class CommitStatuses
    {
        ...
        [JsonProperty("target_url")] public string Target_url { get; set; }
        [JsonProperty("description")] public string Description { get; set; }
        [JsonProperty("created_at")] public DateTime Created_at { get; set; }
        [JsonProperty("started_at")] public DateTime Started_at { get; set; }
        [JsonProperty("finished_at")] public DateTime Finished_at { get; set; }
        [JsonProperty("allow_failure")] public bool Allow_failure { get; set; }
