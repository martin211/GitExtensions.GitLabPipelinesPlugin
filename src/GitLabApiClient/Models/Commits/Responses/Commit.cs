...
namespace GitLabApiClient.Models.Commits.Responses
{
    public sealed class Commit
    {
        ...
        [JsonProperty("authored_date")] public DateTime AuthoredDate { get; set; }
        ...
        [JsonProperty("committed_date")] public DateTime CommittedDate { get; set; }
        [JsonProperty("created_at")] public DateTime CreatedAt { get; set; }
        [JsonProperty("message")] public string Message { get; set; }
        [JsonProperty("parent_ids")] public List<string> ParentIds { get; } = new List<string>();
