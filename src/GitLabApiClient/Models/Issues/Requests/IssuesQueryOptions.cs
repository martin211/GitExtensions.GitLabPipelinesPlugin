...
namespace GitLabApiClient.Models.Issues.Requests
{
    ...
    public class IssuesQueryOptions
    {
        ...
        /// <summary>
        ///     Return issues created by the given username. Similar to <see cref="AuthorId" /> and mutually exclusive with
        ///     <see cref="AuthorId" />.
        /// </summary>
        ...
        /// <summary>
        ///     Return issues assigned to the given username. Similar to <see cref="AssigneeId" /> and mutually exclusive with
        ///     <see cref="AuthorId" />.
        ///     In CE version <see cref="AuthorUsername" /> list should only contain a single value or an invalid param error will
