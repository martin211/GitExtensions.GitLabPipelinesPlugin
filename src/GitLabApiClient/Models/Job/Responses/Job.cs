...
namespace GitLabApiClient.Models.Job.Responses
{
    ...
    {
        [JsonProperty("allow_failure")] public bool AllowFailure { get; set; }

        [JsonProperty("artifacts_expire_at")] public DateTime ArtifactsExpireAt { get; set; }
        ...
        [JsonProperty("runner")] public Runner Runner { get; set; }
