...
namespace GitLabApiClient.Models.Releases.Responses
{
    public sealed class Commit
    {
        ...
        [JsonProperty("parent_ids")] public string[] ParentIds { get; set; }
        ...
        [JsonProperty("authored_date")] public string AuthoredDate { get; set; }
        ...
        [JsonProperty("committed_date")] public string CommittedDate { get; set; }
    }
}
