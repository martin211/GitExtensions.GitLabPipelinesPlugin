...
namespace GitLabApiClient.Models.Projects.Responses
{
    ...
    {
        [JsonProperty("last_activity_at")] public string LastActivityAt { get; set; }
        ...
        [JsonProperty("import_error")] public string ImportError { get; set; }

        [JsonProperty("http_url_to_repo")] public string HttpUrlToRepo { get; set; }

        [JsonProperty("forks_count")] public int ForksCount { get; set; }

        [JsonProperty("id")] public int Id { get; set; }

        [JsonProperty("issues_enabled")] public bool IssuesEnabled { get; set; }

        [JsonProperty("import_status")] public string ImportStatus { get; set; }

        [JsonProperty("jobs_enabled")] public bool JobsEnabled { get; set; }

        [JsonProperty("owner")] public Owner Owner { get; set; }

        [JsonProperty("namespace")] public Namespace Namespace { get; set; }
        ...
        [JsonProperty("public_jobs")] public bool PublicJobs { get; set; }
        ...
        [JsonProperty("runners_token")] public string RunnersToken { get; set; }
        ...
        [JsonProperty("ssh_url_to_repo")] public string SshUrlToRepo { get; set; }

        [JsonProperty("snippets_enabled")] public bool SnippetsEnabled { get; set; }

        [JsonProperty("star_count")] public int StarCount { get; set; }

        [JsonProperty("visibility")] public ProjectVisibilityLevel Visibility { get; set; }

        [JsonProperty("tag_list")] public List<string> TagList { get; } = new List<string>();

        [JsonProperty("web_url")] public string WebUrl { get; set; }

        [JsonProperty("wiki_enabled")] public bool WikiEnabled { get; set; }
    }
}
