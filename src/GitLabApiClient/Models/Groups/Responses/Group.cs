...
namespace GitLabApiClient.Models.Groups.Responses
{
    public sealed class Group
    {
        ...
        [JsonProperty("visibility")] public GroupsVisibility Visibility { get; set; }

        [JsonProperty("lfs_enabled")] public bool LfsEnabled { get; set; }
        ...
        [JsonProperty("projects")] public IList<Project> Projects { get; } = new List<Project>();
    }
}
