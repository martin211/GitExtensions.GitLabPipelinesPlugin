namespace GitLabApiClient.Models.Groups.Requests
{
    ...
    public class ProjectsGroupQueryOptions
    {
        ...
        /// <summary>
        ///     Limit to projects where current user has at least this
        ///     <a href="https://docs.gitlab.com/ee/api/members.html">access level</a>
        /// </summary>
        public AccessLevel? MinAccessLevel { get; set; }

        /// <summary>
        ///     Include <a href="https://docs.gitlab.com/ee/api/custom_attributes.html">custom attributes</a> in response (admins
        ///     only)
        /// </summary>
        public bool WithCustomAttributes { get; set; }

        /// <summary>
        ///     Return only projects that have security reports artifacts present in any of their builds. This means “projects with
        ///     security reports enabled”. Default is false
