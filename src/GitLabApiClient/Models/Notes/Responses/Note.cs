...
namespace GitLabApiClient.Models.Notes.Responses
{
    ...
    {
        [JsonProperty("noteable_id")] public int NoteableId { get; set; }

        [JsonProperty("noteable_iid")] public int NoteableIid { get; set; }

        [JsonProperty("noteable_type")] public string NoteableType { get; set; }
        ...
        [JsonProperty("resolvable")] public bool Resolvable { get; set; }

        [JsonProperty("resolved")] public bool? Resolved { get; set; }

        [JsonProperty("resolved_by")] public Author ResolvedBy { get; set; }
